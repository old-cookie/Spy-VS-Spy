...
public class RisingPlatformtoLeft : MonoBehaviour
{
    public float jumpForce = 10.0f; // Upward force
    public float sideForce = 5.0f;   // Force to apply to the left
    ...
    private IEnumerator RisePlayer(Rigidbody playerRigidbody)
    {
        ...
        playerRigidbody.AddForce(Vector3.left * sideForce, ForceMode.Impulse);
